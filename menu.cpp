...
void showMenu() {
    ...
    std::cout << "5. Show wish list\n";
    std::cout << "6. Countdown to New Year\n";
    std::cout << "0. Exit\n";
}
...
void countdownToNewYear() {
    ...
    auto newYearTime = currentTime() + (static_cast<long long>(1 * 24 * 60) * 60);  // 1 день * 24 години * 60 хвилин * 60 секунд
